...
/*
 * Intercambia la posicion de dos elementos cuyos indices se reciben por parametro.
 * 
 * La funcion retorna 0 en caso de que se haya podido realizar correctamente o -1 en caso
 * de error.
*/
